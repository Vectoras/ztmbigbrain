(function () {
...
})()(
  {
    ...
    11: [
      ...
      { "../helpers/buildURL": 22, "./../utils": 31, "./InterceptorManager": 12, "./dispatchRequest": 15, "./mergeConfig": 17 },
    ],
    12: [
      function (require, module, exports) {
        "use strict";
    ...
    13: [
      ...
      { "../helpers/combineURLs": 23, "../helpers/isAbsoluteURL": 25 },
    ],
    14: [
      function (require, module, exports) {
        "use strict";
    ...
    15: [
      ...
      { "../cancel/isCancel": 10, "../defaults": 20, "./../utils": 31, "./transformData": 19 },
    ],
    16: [
      function (require, module, exports) {
        "use strict";
    ...
    20: [
      ...
      { "./adapters/http": 6, "./adapters/xhr": 6, "./helpers/normalizeHeaderName": 28, "./utils": 31, _process: 1 },
    ],
    21: [
      function (require, module, exports) {
        "use strict";
    ...
    32: [
                ...
                },
                {
                  ...
                  value: function _validate(_ref) {
                    ...
                    if (clientId || clientSecret) {
                      console.warn(
                        "Client ID/secret has been deprecated. Please switch to using the API key. See here how to do " +
      ...
      { "./Concepts": 34, "./Inputs": 36, "./Models": 39, "./Workflow": 42, "./Workflows": 43, "./constants": 44, "./helpers": 45, "./solutions/Solutions": 48, _process: 1, axios: 5, promise: 51 },
    ],
    33: [
      function (require, module, exports) {
        "use strict";
    ...
    34: [
      ...
      { "./Concept": 33, "./constants": 44, "./helpers": 45, "./utils": 49, axios: 5 },
    ],
    35: [
      function (require, module, exports) {
        "use strict";
      ...
      { "./Concepts": 34, "./Regions": 41, "./constants": 44, axios: 5 },
    ],
    36: [
      function (require, module, exports) {
        "use strict";
      ...
      { "./Input": 35, "./constants": 44, "./helpers": 45, "./utils": 49, axios: 5 },
    ],
    37: [
      function (require, module, exports) {
        "use strict";
      ...
      { "./ModelVersion": 38, "./constants": 44, "./helpers": 45, "./utils": 49, axios: 5 },
    ],
    38: [
      function (require, module, exports) {
        "use strict";
    ...
    39: [
          ...
          _createClass(Models, [
            {
              ...
              value: function initModel(model) {
                ...
                if (data.id) {
                  ...
                  fn = function fn(resolve, reject) {
                    _this2
                      .search(data.name, data.type)
                      .then(function (models) {
                        if (data.version) {
                          resolve(
                            models.rawData.filter(function (model) {
            ...
            },
            {
              ...
              value: function create(model) {
                ...
                var concepts =
                  conceptsData instanceof Concepts
                    ? conceptsData.toObject("id")
                    : conceptsData.map(function (concept) {
                        var val = concept;
      ...
      { "./Concepts": 34, "./Model": 37, "./constants": 44, "./helpers": 45, "./utils": 49, axios: 5, promise: 51 },
    ],
    40: [
      function (require, module, exports) {
        "use strict";
    ...
    42: [
      ...
      { "./constants": 44, "./helpers": 45, "./utils": 49, axios: 5 },
    ],
    43: [
      function (require, module, exports) {
        "use strict";
      ...
      { "./Workflow": 42, "./constants": 44, "./helpers": 45, "./utils": 49, axios: 5 },
    ],
    44: [
      function (require, module, exports) {
        "use strict";
        ...
        module.exports = {
          ...
          ERRORS: {
            ...
            INVALID_DELETE_ARGS: new Error(
              "Wrong arguments passed. You can only delete all models (provide no arguments), delete select models (provide list of ids),\n    delete a single model (providing a single id) or delete a model version (provide a single id and version id)"
            ),
          },
          STATUS: {
    ...
    49: [
      ...
      { "./../package.json": 50, "./constants": 44, "./helpers": 45, promise: 51, "valid-url": 59 },
    ],
    50: [
      function (require, module, exports) {
        module.exports = {
          ...
          _spec: "clarifai",
          _where: "C:\\Users\\Ionut\\Desktop\\Programare\\4.Udemy\\5-The_Complete_Web_Developer_in 2021_Zero_to_Mastery\\Smart Brain",
          author: {
            name: "Clarifai Inc.",
          },
          bugs: {
    ...
    56: [
      ...
      { "./core.js": 52, "./done.js": 53, "./es6-extensions.js": 54, "./finally.js": 55, "./node-extensions.js": 57, "./synchronous.js": 58 },
    ],
    57: [
      function (require, module, exports) {
        "use strict";
